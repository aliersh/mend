...
// Deployed PontiFactory and Circle's native USDC on Base Sepolia.
export const FACTORY_ADDRESS = '0x17463e06C303e30044609a9a412d7DB4746Cb210' as const
export const USDC_ADDRESS = '0x036CbD53842c5426634e7929541eC2318f3dCF7e' as const

// Factory deploy block — used as createdBlock fallback on cold-load.
export const FACTORY_DEPLOY_BLOCK = 42590257n
